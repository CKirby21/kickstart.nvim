...
vim.keymap.set('n', '<leader>pv', vim.cmd.Ex, { desc = 'Explore directory' })

vim.keymap.set('v', 'J', ":m '>+1<CR>gv=gv", { desc = 'Move lines down' })
vim.keymap.set('v', 'K', ":m '<-2<CR>gv=gv", { desc = 'Move lines up' })

-- Keep cursor in the middle of the screen at all costs
...
vim.keymap.set('n', '<leader>x', '<cmd>!chmod +x %<CR>', { desc = 'Set E[x]ecute Permissions', silent = true })
...
require('lazy').setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
        ...
        config = function()
            ...
            local brain = os.getenv('HOME') .. '/repos/brain'
            vim.keymap.set('n', '<leader>fb', function()
                builtin.find_files { cwd = brain }
            end, { desc = '[F]ind [B]rain files' })

            vim.keymap.set('n', '<leader>sb', function()
                builtin.live_grep { cwd = brain }
            end, { desc = '[S]earch [B]rain' })
        end,
    },
    ...
    { -- Highlight, edit, and navigate code
        ...
        config = function()
            ...
            require('nvim-treesitter.configs').setup {
                ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'rust', 'cpp', 'python', 'java', 'ruby' },
